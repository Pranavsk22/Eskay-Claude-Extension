// tokenizer.js - Handles BPE tokenization, conversation tree parsing, and token caching
(() => {
  'use strict';
  ...
  function countTokens(text) {
    ...
    // Fallback: approximate counting (~4 chars per token)
  ...
  window.EskayTokenizer = EskayTokenizer;
})();
